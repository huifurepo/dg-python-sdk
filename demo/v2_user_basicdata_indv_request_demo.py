...
def getDb2bd6a770dd4fbc80f23305842efb38():
    dto = dict()
    # 文件类型
    dto["file_type"] = "F04"
    # 文件jfileID
...
def build_extend_infos():
    ...
    # 文件列表
    extend_infos["file_list"] = getDb2bd6a770dd4fbc80f23305842efb38()
    # 所属行业
    # extend_infos["mcc"] = ""
    # 省
    # extend_infos["prov_id"] = ""
    # 市
    # extend_infos["area_id"] = ""
    # 区
    # extend_infos["district_id"] = ""
    return extend_infos
