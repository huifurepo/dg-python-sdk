...
def get68d1322323b04623Baf08462a64b731d():
    dto = dict()
    # 补贴方汇付编号
    # dto["huifu_id"] = "test"
    # 补贴方类型
...
def get1c595ea4332b42cc8ac8Aa44eb5fc579():
    dto = dict()
    # 交易设备ip
...
def get58632caaC6844b46Aa0e1f192cc7c1f1():
    dto = dict()
...
def getF459eb2755d4496dA22633b514331e0c():
    dto = dict()
    # 业务种类
    dto["biz_tp"] = "012345"
    # 商品简称
...
def get42e47512E9a6418680173509165b2100():
    dto = dict()
    # 分账信息列表
...
def get1d06be63D3244552Bd188fa04a8e6ee4():
    dto = dict()
    # 支付金额
    # dto["div_amt"] = ""
    # 商户号
...
def build_extend_infos():
    ...
    # 分账对象
    # extend_infos["acct_split_bunch"] = get42e47512E9a6418680173509165b2100()
    # 补贴支付信息
    # extend_infos["combinedpay_data"] = get68d1322323b04623Baf08462a64b731d()
    return extend_infos
...
class TestV2TradeOnlinepaymentWithholdpayRequestDemo(unittest.TestCase):
    ...
    def test_request(self):
        ...
        request.extend_pay_data = getF459eb2755d4496dA22633b514331e0c()
        request.risk_check_data = get58632caaC6844b46Aa0e1f192cc7c1f1()
        request.terminal_device_data = get1c595ea4332b42cc8ac8Aa44eb5fc579()
