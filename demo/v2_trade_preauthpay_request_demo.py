...
def get4a4f4c37D30a405fB03aB630cd659632():
    dto = dict()
    # 商户终端序列号
    dto["app_version"] = ""
    # 交易设备GPS
...
def get4144db46B82147ec88aeE3e50491fe02():
    dto = dict()
    # 基站地址
...
def build_extend_infos():
    ...
    # 设备信息
    extend_infos["terminal_device_data"] = get4a4f4c37D30a405fB03aB630cd659632()
    # 异步通知地址
...
class TestV2TradePreauthpayRequestDemo(unittest.TestCase):
    ...
    def test_request(self):
        ...
        request.risk_check_data = get4144db46B82147ec88aeE3e50491fe02()
