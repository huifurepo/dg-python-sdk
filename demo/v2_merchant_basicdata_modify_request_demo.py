...
def get48c5d1f8330f4e8b880aBefad36b0aaf():
    dto = dict()
    # 股东姓名
    # dto["name"] = "test"
    # 股东证件类型
...
def get0c477a60A33445bf8a96464788abe8e9():
    dto = dict()
    # 电子账户开关
...
def get284f0185740d4dd3Bf1409a33a5e2f61():
    dto = dict()
    # 银行编码
    # dto["bank_code"] = "test"
    # 支行联行号
...
def get0e652d5c278b4b6289416af49f5827aa():
    dto = dict()
    # 文件id
    # dto["file_id"] = "test"
    # 文件类型
...
def getAd408404B0764f60896838dca28e34d6():
    dto = dict()
    # 协议类型
...
def get7b55b7d7391d43908eed85e6b73af3fd():
    dto = dict()
    # 签约人类型
    # dto["type"] = "test"
    # 姓名
...
def get92d7aa547c6c4e40Bfba92b33a3e6691():
    dto = dict()
    # 受益人名称
    # dto["bo_name"] = "test"
    # 受益人证件类型
...
def getA2194d6e98dd4dce9d79C15b8a52a54c():
    dto = dict()
    # 结算开关
    dto["settle_status"] = "1"
    # 结算周期
...
def getB4c12b9e620844179e02A63a50bae972():
    dto = dict()
    # 状态
    dto["switch_state"] = "1"
    # 业务类型
...
def get7b629edd5720480eA2d1527ccceead1a():
    dto = dict()
    # 结算账户类型
    dto["card_type"] = "1"
    # 结算账户名
...
def build_extend_infos():
    ...
    # 注册资本
    # extend_infos["reg_capital"] = ""
    # 经营范围
    # extend_infos["business_scope"] = ""
    # 成立时间
    # extend_infos["found_date"] = ""
    # 法人姓名
    ...
    # 法人身份证地址
    # extend_infos["legal_addr"] = ""
    # 法人手机号
    # extend_infos["legal_mobile_no"] = ""
    # *负责人职业*
    ...
    # *结算卡信息配置*
    extend_infos["card_info"] = get7b629edd5720480eA2d1527ccceead1a()
    # 结算协议图片文件
    # extend_infos["settle_agree_pic"] = ""
    # 基本存款账户编号或核准号
    # extend_infos["open_licence_no"] = ""
    # 取现信息配置
    extend_infos["cash_config"] = getB4c12b9e620844179e02A63a50bae972()
    # 结算规则配置
    extend_infos["settle_config"] = getA2194d6e98dd4dce9d79C15b8a52a54c()
    # 商户主页URL
    # extend_infos["mer_url"] = ""
    # 商户ICP备案编号
    # extend_infos["mer_icp"] = ""
    # 受益人列表
    # extend_infos["beneficiary_info"] = get92d7aa547c6c4e40Bfba92b33a3e6691()
    # 协议信息
    # extend_infos["agreement_info"] = getAd408404B0764f60896838dca28e34d6()
    # 营业执照图片
    # extend_infos["license_pic"] = ""
    # 授权委托书
    # extend_infos["auth_entrust_pic"] = ""
    # 场景类型
    # extend_infos["scene_type"] = ""
    # 店铺门头照
    # extend_infos["store_header_pic"] = ""
    # 店铺内景/工作区域照
    # extend_infos["store_indoor_pic"] = ""
    # 店铺收银台/公司前台照
    # extend_infos["store_cashier_desk_pic"] = ""
    # 扩展资料包
    # extend_infos["extended_material_list"] = get0e652d5c278b4b6289416af49f5827aa()
    # 异步通知地址
    extend_infos["async_return_url"] = "archer://C_SSPM_NSPOSM_BUSIRESULT"
    # 斗拱e账户功能配置
    # extend_infos["elec_acct_config"] = get0c477a60A33445bf8a96464788abe8e9()
    # 股东信息
    # extend_infos["share_holder_info_list"] = get48c5d1f8330f4e8b880aBefad36b0aaf()
    # 外部商户号
...
class TestV2MerchantBasicdataModifyRequestDemo(unittest.TestCase):
    ...
    def test_request(self):
        ...
        request.sign_user_info = get7b55b7d7391d43908eed85e6b73af3fd()
