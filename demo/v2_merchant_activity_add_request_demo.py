...
def getEd6068c8514647eeBd3eB1900924b7a2():
    dto = dict()
    # 账户名
    dto["card_name"] = "张三"
    # 银行账号
...
def build_extend_infos():
    ...
    # 商户同名银行账户信息
    extend_infos["bank_account"] = getEd6068c8514647eeBd3eB1900924b7a2()
    # 银行开户证明图片
    ...
    # 活动费率%
    # extend_infos["preferential_rate"] = ""
    # 活动到期后费率%
    # extend_infos["expiration_rate"] = ""
    # 学校号
    # extend_infos["school_id"] = ""
    return extend_infos
