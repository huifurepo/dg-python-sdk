...
def build_extend_infos():
    ...
    extend_infos = dict()
    # 子渠道号
    extend_infos["pay_channel_id"] = "10000001"
    # 业务开通类型
    extend_infos["pay_scene"] = "1"
    # 法人身份信息
    extend_infos["legal_person_info"] = getLegalPersonInfo()
    # 受益人信息
    extend_infos["ubo_info"] = getUboInfo()
    return extend_infos


class TestV2MerchantBusiAliRealnameApplyRequestDemo(unittest.TestCase):
    ...
    def test_request(self):
        ...
        # 接口请求对象
        request = dg_sdk.V2MerchantBusiAliRealnameApplyRequest()
        request.req_seq_id = ""
        request.req_date = ""
        request.huifu_id = "6666000105418240"
        request.auth_identity_info = getAuthIdentityInfo()
        request.contact_person_info = getContactPersonInfo()
