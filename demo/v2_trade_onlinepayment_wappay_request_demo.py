...
def get642463d25eb543ffB49d07c169d8229b():
    dto = dict()
    # 交易设备ip
...
def getEd6bb3aaBe474bba91da630a1272ee02():
    dto = dict()
    # ip地址
    dto["ip_addr"] = "111"
    # 基站地址
...
def getFc676215E3594ef1Ba9e03f35781872f():
    dto = dict()
    # 分账信息列表
...
def get26c547a0B0894cfaAc8509ea166da9ae():
    dto = dict()
    # 支付金额
    # dto["div_amt"] = ""
    # 分账接收方ID
...
def getE236f3e2A5774278813b68f967f8db3e():
    dto = dict()
    # 商品简称
...
def build_extend_infos():
    ...
    # 分账对象
    extend_infos["acct_split_bunch"] = getFc676215E3594ef1Ba9e03f35781872f()
    # 备注
    extend_infos["remark"] = ""
    # 页面失败跳转地址
...
class TestV2TradeOnlinepaymentWappayRequestDemo(unittest.TestCase):
    ...
    def test_request(self):
        ...
        request.extend_pay_data = getE236f3e2A5774278813b68f967f8db3e()
        request.risk_check_data = getEd6bb3aaBe474bba91da630a1272ee02()
        request.terminal_device_data = get642463d25eb543ffB49d07c169d8229b()
