...
def get79fb2f88C61b423e8bd8B4696ecef9d7():
    dto = dict()
    # 交易设备GPS
...
def getBa2f25bc65d74cb3988e7e446466b598():
    dto = dict()
    # 基站地址
...
def build_extend_infos():
    ...
    # 设备信息
    extend_infos["terminal_device_info"] = get79fb2f88C61b423e8bd8B4696ecef9d7()
    # 异步通知地址
...
class TestV2TradePaymentPreauthcancelRefundRequestDemo(unittest.TestCase):
    ...
    def test_request(self):
        ...
        request.risk_check_info = getBa2f25bc65d74cb3988e7e446466b598()
