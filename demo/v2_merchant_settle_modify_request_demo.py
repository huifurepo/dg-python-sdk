...
def get0abd73495f2b4147B17b45cc26cbaa48():
    dto = dict()
    # 结算账户类型
    dto["card_type"] = "0"
    # 结算账户名
...
def getBba81a50640243a6A37cBa656e0f396c():
    dto = dict()
    # 状态
    dto["settle_status"] = "0"
    # 结算周期
...
class TestV2MerchantSettleModifyRequestDemo(unittest.TestCase):
    ...
    def test_request(self):
        ...
        # 接口请求对象
        request = dg_sdk.V2MerchantSettleModifyRequest()
        request.req_seq_id = ""
        request.req_date = ""
        request.huifu_id = "6666000106071234"
        request.upper_huifu_id = "6666000106065087"
        request.acct_id = "C01571234"
        request.settle_config = getBba81a50640243a6A37cBa656e0f396c()
        request.card_info = get0abd73495f2b4147B17b45cc26cbaa48()
