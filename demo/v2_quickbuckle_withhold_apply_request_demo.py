...
def getF494b2e9E5cf4fe592d8Fa81cc893071():
    dto = dict()
    # IP类型
    dto["ip_type"] = "04"
    # IP值
...
def getB56bfbeeE390414999542cc647b3ed9a():
    dto = dict()
    # 银行预留手机号
...
def build_extend_infos():
    ...
    # CVV2
    extend_infos["vip_code"] = "HOVFKOon3Dl4Q9cjze21X902G8Dnl2LvLFJd8RE+Lp6XKiIbVUCA1wd2Otp2jI2D32z5gUFqUbB4clRZyRyltXV3xmAWH4fLZDER3H+YwAk94s2sO2Sz/6q4Jg2xDieesO2Sz/6q4Jg2xDieeGDGbQzL12MvPQU/GX14xJzGvvd="
    # 卡有效期
    extend_infos["expiration"] = "IUtn4JmBVMTDtrqKLCWeoY7WP4hQAz3rptjOe8WsuySW+34SkZJO4Azy6BknTGkk6EA2soLbwLQ5SkZJO4Azy6BknTGkk6EX902G8Dnl2/2rpH8wpJUnufoYnI0nR9YDTbGA+G0v+ApOJL3ShiZxgLvnTaKrnU4iYH171KB4="
    # 个人证件有效期到期日
    extend_infos["cert_end_date"] = "20260504"
    # 设备信息域
    extend_infos["trx_device_info"] = getB56bfbeeE390414999542cc647b3ed9a()
    # 风控信息
    extend_infos["risk_info"] = getF494b2e9E5cf4fe592d8Fa81cc893071()
    # 代扣绑卡类型
    # extend_infos["binding_card_type"] = ""
    return extend_infos
