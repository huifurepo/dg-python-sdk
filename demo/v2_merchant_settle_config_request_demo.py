...
def getE6ef033d442546e98a06E8c0b807e70c():
    dto = dict()
    # 结算周期
    dto["settle_cycle"] = "D1"
...
def get4dc0754b0dda4807906674d64786b6c3():
    dto = dict()
    # 结算账户类型
    dto["card_type"] = "0"
    # 结算账户名
...
def build_extend_infos():
    ...
    extend_infos = dict()
    # 结算规则配置
    extend_infos["settle_config"] = getE6ef033d442546e98a06E8c0b807e70c()
    # 异步请求地址
    extend_infos["async_return_url"] = ""
    return extend_infos


class TestV2MerchantSettleConfigRequestDemo(unittest.TestCase):
    ...
    def test_request(self):
        ...
        # 接口请求对象
        request = dg_sdk.V2MerchantSettleConfigRequest()
        request.req_seq_id = ""
        request.req_date = ""
        request.huifu_id = "6666000106071234"
        request.upper_huifu_id = "6666000106065087"
        request.acct_type = "02"
        request.acct_name = "现金账户"
        request.card_info = get4dc0754b0dda4807906674d64786b6c3()
