...
class TestV2QuickbuckleBindCardinfoQueryRequestDemo(unittest.TestCase):
    ...
    def test_request(self):
        ...
        # 接口请求对象
        request = dg_sdk.V2QuickbuckleBindCardinfoQueryRequest()
        request.req_seq_id = ""
        request.req_date = ""
        ...
        request.cert_no = "test"
        request.card_mobile = "test"
