...
def build_extend_infos():
    ...
    # 取现渠道
    extend_infos["enchashment_channel"] = "00"
    # 备注
    # extend_infos["remark"] = ""
    # 异步通知地址
...
class TestV2TradeSettlementEncashmentRequestDemo(unittest.TestCase):
    ...
    def test_request(self):
        ...
        # 接口请求对象
        request = dg_sdk.V2TradeSettlementEncashmentRequest()
        request.req_date = ""
        request.req_seq_id = ""
