...
def getF4bde40271004009B265Ae9d23bf5967():
    dto = dict()
    # 文件类型
    # dto["file_type"] = "test"
    # 文件jfileID
...
def build_extend_infos():
    ...
    # 文件列表
    # extend_infos["file_list"] = getF4bde40271004009B265Ae9d23bf5967()
    # 公司类型
...
class TestV2UserBasicdataEntRequestDemo(unittest.TestCase):
    ...
    def test_request(self):
        ...
        request.legal_cert_nationality = "test"
        request.contact_name = "小的"
        request.contact_mobile = "13764462211"
        request.login_name = "Lg2022022201374721361"
