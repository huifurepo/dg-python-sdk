...
def get99f5455594464feeAa6a9f39230613f8():
    dto = dict()
    # 商户终端版本号
    dto["app_version"] = ""
    # 交易设备GPS
...
def get88a48f6c221e4ff5B8006bf8874c4dd3():
    dto = dict()
    # 基站地址
...
def get7dd691ab53b04a40Bc4085a152d039a5():
    dto = dict()
    # 附加数据
    dto["attach"] = ""
    # 商品详情
...
def get3f7b8679D63e470a90c9F1bda7adaa66():
    dto = dict()
    # 门店信息
...
def get77b20125Baf94a3dA333C5fdeb7033d0():
    dto = dict()
    # 门店详细地址
    dto["address"] = "汇付天下桂林路"
    # 门店行政区划码
...
def get0a4d393026664aa68b07Be0921a28479():
    dto = dict()
    # 单品列表
...
def get1475c6ac101f41fcBb3e7240e5b8b639():
    dto = dict()
    # 商品编码
...
def get386c6c5f282c46f1A7232adc003f8634():
    dto = dict()
    # 支付宝的店铺编号
    dto["alipay_store_id"] = ""
    # 业务扩展参数
...
def get334aa3af21e2449b9ef567aef6e832f3():
    dto = dict()
    # 商品的编号
...
def getFc5a9d0c6088469684325146af94fd15():
    dto = dict()
    # 卡类型
    dto["card_type"] = ""
    # 支付宝点餐场景类型
...
def build_extend_infos():
    ...
    # 支付宝扩展参数集合
    extend_infos["alipay_data"] = get386c6c5f282c46f1A7232adc003f8634()
    # 微信扩展参数集合
    extend_infos["wx_data"] = get7dd691ab53b04a40Bc4085a152d039a5()
    # 商户扩展域
    ...
    # 设备信息
    extend_infos["terminal_device_data"] = get99f5455594464feeAa6a9f39230613f8()
    # 异步通知地址
...
class TestV2TradePreauthRequestDemo(unittest.TestCase):
    ...
    def test_request(self):
        ...
        request.risk_check_data = get88a48f6c221e4ff5B8006bf8874c4dd3()
